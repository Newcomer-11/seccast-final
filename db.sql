...
-- ── Bảng access_history (lưu họ tên, địa chỉ người vào site) ──
...
CREATE INDEX IF NOT EXISTS idx_access_history_submitted_at ON access_history(submitted_at DESC);

ALTER TABLE access_history ENABLE ROW LEVEL SECURITY;
CREATE POLICY "Service all access_history" ON access_history FOR ALL USING (true);